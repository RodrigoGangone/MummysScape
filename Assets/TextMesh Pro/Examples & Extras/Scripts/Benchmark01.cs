    ...
    public class Benchmark01 : MonoBehaviour
    {
        ...
        IEnumerator Start()
        {
            ...
            if (BenchmarkType == 0) // TextMesh Pro Component
            {
                ...
                m_material02 = Resources.Load<Material>("Fonts & Materials/LiberationSans SDF - DropBandage Shadow"); // Make sure the LiberationSans SDF exists before calling this...  
