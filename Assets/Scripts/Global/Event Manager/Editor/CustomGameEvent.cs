...
/// <summary> 
/// Herramienta de Depuración: Extensión del Editor de Unity que permite visualizar la lista de 
/// suscriptores en tiempo real y disparar eventos manualmente durante el modo de juego. 
/// </summary>
...
public class CustomGameEvent : Editor
{
    ...
    private void DrawSubscribers(GameEvent evt)
    {
        ...
        {
            var real = TryUnwrapRealDelegate(d) ?? d; 
